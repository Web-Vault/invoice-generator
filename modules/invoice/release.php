...
<body style="background-color: #f8f9fa; font-family: Arial, sans-serif; line-height: 1.3; margin: 0; padding: 0; box-sizing: border-box;">
    <div style="width: 100%; max-width: 1200px; padding: 20px; background-color: #fff; border-radius: 10px;">
        <div style="display: flex; justify-content: space-between; margin-bottom: 20px;">
                <div style="max-width: 200px;">
                        <img src="company_logo/' . htmlspecialchars($invoice_data['invoice_logo']) . '" class="img-fluid" style="max-height: 100px;" />
                </div>
        ...
        <div style="margin-top: 20px;">
                ...
                <div style="display: flex; flex-direction: column; align-items: end; text-align: right; padding: 20px;">
                        <div style="padding: 8px 0;  display: block; width: 65%;">
